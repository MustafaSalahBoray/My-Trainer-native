...
<body>
   <?php
    ...
    $result=9;
    $numberPage=$db->prepare("SELECT * FROM back WHERE Stuts='Home'");
    $numberPage->execute();
  ...
  <div class="container pt-4" style='margin-bottom: 50px; ' >
        <div class="row gy-4" >
            <?php $results=$db->prepare("SELECT * FROM back WHERE Stuts='Home' LIMIT " . $result . " OFFSET " .($page-1)*$result );
     $results->execute();
  ...
  <ul class="pagination  justify-content-center"> 
         <?php  
       if ($page>1) {
   echo '   <li class="page-item"><a class=" btn btn-dark" href="BackHome.php?page='.($page-1).'">Previously </a></li>';}?>
     <?php  
   ...
   echo '  <li class="page-item"><a class=" btn btn-danger" style="color:black" href="Back.php?page='.$count.'">'.$count.'</a></li>';}
            else {   echo '  <li class="page-item"><a class="btn btn-danger" class="page-link " href="BackHome.php?page='.$count.'">'.$count.'</a></li>';}
    } ?>
    <?php  
       if ($count>$page) {
   echo '   <li class="page-item"><a class=" btn btn-dark" href="BackHome.php?page='.($page+1).'">Next</a></li>';}?>
  </ul>
</nav>   
